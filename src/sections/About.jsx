...
>
  ...
  {/* Text content layer */}
  <div className="relative z-15 w-full px-6 py-8 text-white">
    <p className="headtext mb-8 text-3xl">Education:-</p>

    <div className="flex flex-col gap-6">
      <div>
        <p className="flex items-center gap-2 text-2xl font-semibold mb-2">
          <span>🎓</span> B.Tech in Computer Science
        </p>
        <p className="text-xl text-white/90">Dr. A.P.J. Abdul Kalam Technical University (AKTU)</p>
        <p className="text-lg text-white/80 italic">2022 – 2026</p>
      </div>

      <div className="mt-4">
        <p className="flex items-center gap-2 text-2xl font-semibold mb-2">
          <span>🏫</span> Higher Secondary - CBSE
        </p>
        <p className="text-lg text-white/90">PCM, 2021</p>
        <p className="text-xl text-white/90">Holly Kids International School</p>
      </div>
    </div>
  </div>
</div>
